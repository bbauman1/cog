...
- Automations tab with list, create/edit form, detail view, enable/disable action, and delete confirmation.
...
- Authenticated UI checks:
  ...
  - Automations tab loaded from the live API.
  - Created temporary automation `Codex Test Automation 2026-06-27`, verified it decoded into the list and opened detail with live automation ID `sched-68824c58c3234a80aaa411bf5b0dae7d`, then deleted it and confirmed the list returned to the empty state.
